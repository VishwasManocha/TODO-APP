...
const List = props => {
    ...
    const [initialstyle1 , setInitialStyle1] = useState({
    ...
    return(
        <section className="TodoList">
            ...
            {props.todolist.map( (item) =>{
                return (
                    <List RemoveTodo={props.onRemoveTodo.bind(this , item.id)} key={item.id} title={item.title} description={item.description} />
                )                
            } )}
